...
//			e.printStackTrace();
    ...
    public Analyzer buildPerFieldAnalyzer() {
		...
		analyzerPerField.put("name_search", new StandardAnalyzer());
		...
		analyzerPerField.put("city_search", new StandardAnalyzer());
...
//        	int total = 10;
			...
			for(int i = 0; i <= total; i += batchSize) {
				...
				for(Location a: batch) {
					...
					doc.add(new TextField("name_autocomplete", a.getName(), Field.Store.NO));
					doc.add(new TextField("name_search", a.getName(), Field.Store.NO));
...
//	        			doc.add(new TextField("time_zone", a.getTime_zone(), Field.Store.YES));
					...
					doc.add(new TextField("city_autocomplete", a.getCity(), Field.Store.NO));
					doc.add(new TextField("city_search", a.getCity(), Field.Store.NO));
